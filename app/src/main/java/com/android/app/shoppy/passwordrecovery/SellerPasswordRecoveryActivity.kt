...
class SellerPasswordRecoveryActivity : AppCompatActivity() {
    private lateinit var progressDialog: ProgressDialog
    private lateinit var firebaseAuth: FirebaseAuth
    private var _binding : ActivitySellerPasswordRecoveryBinding? = null
    private val binding get() = _binding!!
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _binding = ActivitySellerPasswordRecoveryBinding.inflate(layoutInflater)
        ...
        if(TextUtils.isEmpty(sellerEmail)){
         ...
         lifecycleScope.launch {
             ...
             try {
                 ...
                 Toast.makeText(this@SellerPasswordRecoveryActivity,"Verification Email has been sent",Toast.LENGTH_SHORT).show()
